...
const PATHS: Record<IconName, ReactElement> = {
  ...
  // 縦横切替（上下2本の折れ矢印を斜めにずらして配置。矢印同士が重ならないよう分離）
  swap: (
    <>
      {/* ↖ 上向きの矢印：左のかぎ形の先端→頂点→右へ下る（上半分） */}
      <path d="M5 9.5 L11 4 L17 10.5" />
      <path d="M5 9.5 L8 9.5 M5 9.5 L5 12.5" />
      {/* ↘ 下向きの矢印：左から下る→谷→右のかぎ形の先端（下半分） */}
      <path d="M7 13.5 L13 20 L19 14.5" />
      <path d="M19 14.5 L16 14.5 M19 14.5 L19 11.5" />
    </>
  ),
  // 太陽（ライトモード）
  sun: (
